...
function Ourwork() {
  ...
  const [inView, setInView] = useState(true); // Track if the element is in the viewport
      ...
      <div className={style.rightWeapper}>
        <div
          ...
          style={{
            ...
            opacity: opacity,
            transition:
              "transform s cubic-bezier(0.25, 0.8, 0.25, 1), opacity 0.9s cubic-bezier(0.25, 0.8, 0.25, 1)", // Adjusted duration and easing for both scale and opacity
